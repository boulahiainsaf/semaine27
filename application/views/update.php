...
foreach ($Produit_detail as $row1)
{
    ...
    echo form_open('Produits/ModifPro/'.$row1->pro_id);
             
            
            
      echo'      <div class="d-flex justify-content-center"  >
            <img class="container-fluid col-lg-6" src="'. base_url().'assets/images/'.$row1->pro_id.'.'.$row1->pro_photo.'"width="50"/><br>
            </div>
            <label for="pro_ref">Référence :</label>
            <input type="text" class="form-control" name="pro_ref" value="' . $row1->pro_ref . '"   >
